...
class TratamientoController extends Controller
{
    ...
    public function destroy($id)
    {
        try {
            ...
            $citasConTratamiento = Cita::where('tratamiento_id', $id)->exists();
            if ($citasConTratamiento) {
                return redirect()->route('tratamientos.index')->with('error', 'No se puede eliminar el tratamiento porque está asociado a una cita.');
            }
