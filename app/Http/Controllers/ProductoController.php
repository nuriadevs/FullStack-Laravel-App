...
class ProductoController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $facturasConProducto = FacturaProducto::where('producto_id', $id)->exists();
            if ($facturasConProducto) {
                return redirect()->route('productos.index')->with('error', 'No se puede eliminar el producto porque está asociado a una factura.');
            }
    ...
    public function buscar(Request $request)
    {
        try {
            ...
            if ($search) {
                $productos = Producto::where('nombre', 'like', '%' . $search . '%')->paginate(10);
